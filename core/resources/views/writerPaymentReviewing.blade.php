...
@section('content')
        ...
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row"><div class="col-xs-6"><strong>Review Writer Payment Report</strong></div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            table = generateTable('.datatable', '{{url('json/rewriterpayments')}}/'+ 0 ,[0,0,0],[]);          
        });
        ...
        $('#search').click(function(e){
            ...
            table = generateTable('.datatable', '{{url('json/rewriterpayments')}}/'+ re ,[0,0,0],[]);
