@extends('layouts.sammy_new.master') @section('title','Completed Projects')
@section('current_title','Waiting for Complete')
@section('content')
    <style type="text/css">
        .bg-black {
            color: #616161;
        ...
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row"><div class="col-xs-6"><strong>Reviewing</strong></div>
		            ...
		            <th class="text-center" style="font-weight:normal;">Added Date</th>
		              @if($hasAcess == 1)
		                  ...
		                  <th class="text-center" style="font-weight:normal;">Writer Deadline</th>
		                   <th class="text-center" style="font-weight:normal;">Reviewer</th>
		              @else
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            table = generateTable('.datatable', '{{url('json/reviewingprojectlist')}}',[0,0,0],[]);
