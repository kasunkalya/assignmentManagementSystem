@extends('layouts.sammy_new.master') @section('title','Writer Rejected Projects')
@section('current_title','Writer Rejected Projects')
@section('content')
    <style type="text/css">
        .bg-black {
            color: #616161;
        ...
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row"><div class="col-xs-6"><strong>Writer Rejected Projects</strong></div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            table = generateTable('.datatable', '{{url('json/writerrejectedprojects')}}',[0,0,0],[]);
