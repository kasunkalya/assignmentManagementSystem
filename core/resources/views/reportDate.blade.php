...
<div class="col-md-3">
                ...
                <div class="panel-body">
                    <table id="testTable" class="table table-bordered bordered table-striped table-condensed datatable">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="font-weight:normal;">Submitted Date</th>
                            <th class="text-center" style="font-weight:normal;">Student Name</th>
                            <th class="text-center" style="font-weight:normal;">Student email address</th>
                            <th class="text-center" style="font-weight:normal;">Student Contact No</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            table = generateTable('.datatable', '{{url('json/reportDate')}}/0/0000-00-00/0000-00-00' , 'get');
        ...
        $('#search').click(function(e){
            ...
            table = generateTable('.datatable', '{{url('json/reportDate')}}/'+ re +'/'+from +'/'+to , 'get');
        });
