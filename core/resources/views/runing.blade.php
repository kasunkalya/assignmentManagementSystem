@extends('layouts.sammy_new.master') @section('title','Running Projects')
@section('current_title','Running Projects')
@section('content')
    <style type="text/css">
        .bg-black {
            color: #616161;
        ...
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row"><div class="col-xs-6"><strong>Running Projects</strong></div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            table = generateTable('.datatable', '{{url('json/runingprojects')}}',[0,0,0],[]);
