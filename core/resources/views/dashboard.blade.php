  ...
  <div class="col-xs-12">
    <div class="panel panel-bordered">
      <div class="panel-heading border">
        <div class="row"><div class="col-xs-6"><strong>New Projects</strong></div>
        ...
        <table class="table table-bordered bordered table-striped table-condensed datatable">
          ...
          <tr>
            ...
            <th class="text-center" style="font-weight:normal;">File</th>
             <th class="text-center" style="font-weight:normal;">Web Site</th>            
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    table = generateTable('.datatable', '{{url('json/list')}}',[0,0,0],[]);
