...
@section('content')
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="col-sm-10">
                                        @if($errors->has('writer'))
                                            {!! Form::select('writer',$userList, Input::old('writer'),['class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'writer']) !!}
                                            <label id="supervisor-error" class="error" for="writer">{{$errors->first('writer')}}</label>
                                        @else
                                            {!! Form::select('writer',$userList,Input::old('writer'),['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'writer']) !!}
                                        @endif
                                    </div>
                                </div>
                                <div class="pull-left">
                ...
                <div class="panel-body">
                    <table class="table table-bordered bordered table-striped table-condensed datatable">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="font-weight:normal;">Email</th>
                            ...
                            <th class="text-center" width="6%" style="font-weight:normal;">Progress</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            table = generateTable('.datatable', '{{url('json/allwriters')}}',[0,6,7],[]);
        });
        ...
        $('#search').click(function(e){
            ...
            table = generateTable('.datatable', '{{url('json/writers')}}/'+ re , 'get');
        });
