...
@section('content')
        ...
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row"><div class="col-xs-6"><strong>Student Payment Report</strong></div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            table = generateTable('.datatable', '{{url('json/studentpayments')}}/'+ 0 ,[0,0,0],[]);          
        });
        ...
        $('#search').click(function(e){
            ...
            table = generateTable('.datatable', '{{url('json/studentpayments')}}/'+ re ,[0,0,0],[]);
