@extends('layouts.sammy_new.master') @section('title','New Projects')
...
@section('content')
        ...
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row"><div class="col-xs-6"><strong>Report</strong></div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            table = generateTable('.datatable', '{{url('assignment/json/writerpayview')}}/'+ 0 ,[0,0,0],[]);
            table1 = generateTable('.datatable1', '{{url('assignment/json/writerrepayview')}}/'+ 0 ,[0,0,0],[]);  
            table2 = generateTable('.datatable2', '{{url('assignment/json/paymentview')}}/'+ 0,[0,0,0],[]); 
        });
        ...
        $('#search').click(function(e){
            ...
            table = generateTable('.datatable', '{{url('assignment/json/writerpayview')}}/'+ re ,[0,0,0],[]);
             $(".datatable1").dataTable().fnDestroy()
            table1 = generateTable('.datatable1', '{{url('assignment/json/writerrepayview')}}/'+ re ,[0,0,0],[]);  
             $(".datatable2").dataTable().fnDestroy()
            table2 = generateTable('.datatable2', '{{url('assignment/json/paymentview')}}/'+ re,[0,0,0],[]); 
        });
