...
@section('current_title','Completed Projects')
@section('content')
    <style type="text/css">
        .bg-black {
            color: #616161;
        ...
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row"><div class="col-xs-6"><strong>Completed Projects</strong></div>
                ...
                <div class="panel-body">
		            ...
		            <th class="text-center" style="font-weight:normal;">Added Date</th>
		              @if($hasAcess == 1)
		                  ...
		                  <th class="text-center" style="font-weight:normal;">Completed Date</th>
		              @else
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            table = generateTable('.datatable', '{{url('json/completedprojects')}}',[0,0,0],[]);
