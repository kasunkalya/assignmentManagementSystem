                ...
                <div class="panel-body">
                    <form role="form" class="form-horizontal form-validation" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                    <input type="text" class="form-control @if($errors->has('email')) error @endif" name="email" placeholder="Email"  value="{{$curUser->email}}">
                                    @if($errors->has('email'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control @if($errors->has('mobileNo')) error @endif" name="mobileNo" placeholder="Mobile No"  value="{{$curUser->mobileNo}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" readonly class="form-control @if($errors->has('username')) error @endif" name="username" placeholder="User Name"  value="{{$curUser->username}}">
