...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="active">Conversation Special Report</li>
    </ol>
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row"><div class="col-xs-6"><strong>Conversation Special Report</strong></div>                      
                    </div>
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-12">  
                                ...
                                <div class="pull-left">                                    
                                    ...
                                    <a href="{{URL('chat/historylist')}}"><button type="button"  class="btn btn-primary"><i class="fa fa-refresh"></i> Cancel</button></a>
                                </div>
                            </div>
                ...
                <div class="panel-body">
                    <table class="table table-bordered bordered table-striped table-condensed datatable">
                        ...
                        <tr>
                            ...
                            <th class="text-center" width="4%"  style="font-weight:normal;">Date</th>    
                            <th class="text-center" width="4%" style="font-weight:normal;">Sender</th>
                            <th class="text-center" width="4%"  style="font-weight:normal;">Receiver</th>                                                    
                            <th class="text-center" width="50%" style="font-weight:normal;">Message</th>
                        </tr>                       
                        </thead>
                    </table>
                </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            table = generateTable('.datatable', '{{url('chat/json/historylist/date')}}/'+from +'/'+to , 'get');
